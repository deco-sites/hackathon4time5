...
const defaultTheme = {
  "primary": "hsla(200, 80%, 45%, 1)", // Deep ocean blue
  "primary-content": "hsla(0, 0%, 100%, 1)", // White
  "secondary": "hsla(45, 90%, 60%, 1)", // Sunny yellow
  "secondary-content": "hsla(0, 0%, 100%, 1)", // White
  "tertiary": "hsla(120, 80%, 50%, 1)", // Fresh green
  "tertiary-content": "hsla(0, 0%, 100%, 1)", // White
  "neutral": "hsla(0, 0%, 35%, 1)", // Dark gray
  "base-100": "hsla(0, 0%, 100%, 1)", // White
  "success": "hsl(90, 60%, 75%)", // Turquoise
  "warning": "hsl(50, 70%, 75%)", // Bright orange
  "error": "hsl(0, 70%, 70%)", // Hot red
  "info": "hsl(200, 60%, 80%)", // Cool blue
