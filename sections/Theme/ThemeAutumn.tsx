...
const defaultTheme = {
  "primary": "hsla(34, 70%, 32%, 1)", // Deep orange/brown
  "primary-content": "hsla(0, 0%, 100%, 1)", // White
  "secondary": "hsla(42, 71%, 49%, 1)", // Warm orange
  "secondary-content": "hsla(0, 0%, 100%, 1)", // White
  "tertiary": "hsla(24, 83%, 54%, 1)", // Burnt sienna
  "tertiary-content": "hsla(0, 0%, 100%, 1)", // White
  "neutral": "hsla(0, 0%, 47%, 1)", // Dark gray
  "base-100": "hsla(0, 0%, 100%, 1)", // White
  "success": "hsl(84, 43%, 74%)", // Olive green
  "warning": "hsl(35, 57%, 70%)", // Mustard yellow
  "error": "hsl(10, 60%, 70%)", // Rust red
  "info": "hsl(40, 82%, 84%)" // Amber
