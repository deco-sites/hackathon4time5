        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
          ...
          <form class="w-full max-w-md lg:col-span-5 lg:pt-2">
            <div class="flex gap-x-4">
              ...
              <button type="submit" class="flex-none rounded-md bg-[#E0AC65] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#DB9F4E] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#E0AC65]">Subscribe</button>
            </div>
