...
export default function HeroOne() {
  return (
    <>
      <div class="relative flex flex-row bg-white p-8 h-[760px] shadow-[0_0_10px_black]">
        <img src="/arrow.svg" alt="arrow" class="absolute w-[100%] -bottom-8 rotate-[30deg] -right-12" />
        ...
        <figure class = "pt-20 h-[80%] w-[40%]">
          ...
          <h1 class = "pt-5 text-2xl w-full text-center text-primary font-extrabold" > Build your Own Website </h1>
        </figure>
        <h1 class = "pt-[25%] text-2xl text-center text-primary font-extrabold">Try Other Layouts</h1>
      </div>
    </>
  );
}
